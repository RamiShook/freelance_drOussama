    ...
    $banner_id =mysqli_real_escape_string($connection, $_POST['banner_id']);
        ...
        if( !empty($_FILES["file"]["name"])){
            ...
            $fullLink = "images/".$fileName;
                ...
                }else{ $response_status.="<span style='color:red'>Something Went Wrong With The Image 1!<br></span>";}
            }else{$response_status.="<span style='color:red'>Something Went Wrong With The Image 2!<br></span>";}
        }else{$response_status.="<span style='color:red'>Something Went Wrong With The Image 3!</span><br>";}
        }


        $display_order            = mysqli_real_escape_string($connection, $_POST['display_order']) ?: 1;       
